                ...
                <div>
                    ...
                    <form name="loginForm" action="<?php print_link('index/login/?csrf_token=' . Csrf::$token); ?>"
                        ...
                        <div class="input-group form-group">
                            <input placeholder="Email" name="username" required="required" class="form-control"
                                type="text" />
                        ...
                        <div class="input-group form-group">
                            ...
                            <input placeholder="Password" required="required" v-model="user.password" name="password"
                        ...
                        <div class="row clearfix mt-3 mb-3">
                            ...
                            <div class="col-6">
                                <a href="<?php print_link('passwordmanager') ?>" class="text-danger"> Reset
                                    Password?</a>
                            </div>
                        ...
                        <div class="text-center" hidden>
                            Don't Have an Account? <a href="<?php print_link("index/register") ?>"
