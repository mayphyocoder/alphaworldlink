...
class EmployersController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("company_name","type_of_company","location","website","phone","email","job_category","age_limit","educational_requirement","working_experience_requirement","other_additional_requirement","estimate_salary_offer","other_allowance","gender","interview_type","date");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","company_name","type_of_company","location","website","phone","email","job_category","age_limit","educational_requirement","working_experience_requirement","other_additional_requirement","estimate_salary_offer","other_allowance","gender","interview_type","date");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'company_name' => 'required',
